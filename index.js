...
function inicio() {
  ...
  lector.onload = function (e) {
    ...
    /* mostrarVistaPrevia(contenido, separadorDetectado); */
...
/*   contenedor.classList.remove("display-none"); */
  ...
  document.getElementById("confirmarSeparadorBtn").onclick = () => {
    const separadorElegido = selector.value;
    procesarCSV(contenido, separadorElegido);
     /* document.getElementById("confirmarSeparadorBtn").style.display ="none"; */
  };
}

function mostrarVistaPrevia(csvText, separador) {
  Papa.parse(csvText, {
    delimiter: separador,
    preview: 5,
    skipEmptyLines: true,
    complete: function (results) {
      ...
      document.getElementById("vistaPreviaContainer").classList.remove("display-none");
    }
  });
}
